...
filename_save <- sprintf("/vsc-hard-mounts/leuven-data/348/vsc34872/weekly_temporal_final/output_physical_%s_sameR0/full_epidemic_simulation_CM_frequency_%03d_%05d", input, R0, id)
