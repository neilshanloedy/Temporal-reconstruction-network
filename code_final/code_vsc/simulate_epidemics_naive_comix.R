...
filename_save <- sprintf("/vsc-hard-mounts/leuven-data/348/vsc34872/weekly_temporal_final/output_CoMix_wave_physical_%04d/full_epidemic_simulation_CM_baseline_%03d_%05d", wave_list, R0, id)
