...
foi_name = foi*10000
filename_save <- sprintf("/vsc-hard-mounts/leuven-data/348/vsc34872/weekly_temporal_final/output_physical_%s_gamma/full_epidemic_simulation_CM_%04d_%03d_%05d", input, as.integer(foi_name), gamma_num, id)
